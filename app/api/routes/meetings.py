...
async def confirm_upload(
    ...
    # Day 1: enqueue Celery transcription task here, e.g.
    #   transcribe_meeting_task.delay(meeting_id)
    # Left out of Day 0 deliberately -- the worker doesn't exist yet.
    logger.info("meeting_confirmed_queued", meeting_id=meeting_id)
